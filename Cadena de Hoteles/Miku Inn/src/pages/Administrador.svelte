<script>
  ...
  function badge(estado) {
    ...
    if (e === 'cerrado' || e === 'inactivo'   || e === 'cancelada' || e === 'inactiva') return 'badge--red';
  ...
  const navItems = [
    ...
    { id: 'reportes',          label: 'Métricas',          icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  ];
</script>
    ...
    <header class="adm__topbar">
      <div class="adm__topbar-left">
        ...
        <h1 class="adm__topbar-title">
          ...
          {:else if activeSection === 'reportes'}Métricas y Estadísticas
          {/if}
        </h1>
