<script>
  ...
  const quickLinks = [
    ...
    { name: 'Vuelos',             page: 'VuelosGenerales' },
...
<footer class="broom-footer">
  <div class="broom-footer__container">
    ...
    <div class="broom-footer__section broom-footer__brand">
      ...
      <div class="broom-footer__social">
        {#each socialLinks as social}
          <a href={social.href} class="broom-footer__social-link" target="_blank" rel="noopener noreferrer" aria-label={social.name}>
            {@html social.icon}
          </a>
        {/each}
      </div>
    ...
    <div class="broom-footer__section">
      ...
      <ul class="broom-footer__links">
        {#each quickLinks as link}
          <li>
            <button class="broom-footer__link" on:click={() => navigateTo(link.page)}>
              {link.name}
            </button>
          </li>
        {/each}
    ...
    <div class="broom-footer__section">
      ...
      <div class="broom-footer__contact-items">
        <div class="broom-footer__contact-item">
        ...
        <div class="broom-footer__contact-item">
          ...
          <span>info@broomairline.com</span>
        </div>
        <div class="broom-footer__contact-item">
  ...
  <div class="broom-footer__bottom">
    <div class="broom-footer__bottom-container">
      ...
      <nav class="broom-footer__legal" aria-label="Legal">
        {#each legalLinks as link, i}
          <button class="broom-footer__legal-link" on:click={() => navigateTo(link.page)}>{link.name}</button>
          {#if i < legalLinks.length - 1}<span class="broom-footer__separator" aria-hidden="true">•</span>{/if}
        {/each}
      </nav>
    </div>
  </div>
