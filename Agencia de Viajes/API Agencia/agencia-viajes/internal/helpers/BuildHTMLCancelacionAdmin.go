...
// BuildHTMLCancelacionAdmin
//
// Genera el HTML del correo electronico que se envía al usuario cuando
// un administrador de Movent cancela su reservacion desde el panel de
// administracion. La plantilla muestra el numero de reservacion y el
...
//   - motivoAdmin:   motivo de cancelacion ingresado por el administrador
//                    (ya viene sin el prefijo "[Admin]")
//
// Retorna:
//   - string: HTML completo listo para enviarse como cuerpo del correo
func BuildHTMLCancelacionAdmin(nombre, apellido, noReservacion, motivoAdmin string) string {
	return fmt.Sprintf(`<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1.0">
<title>MOVENT &middot; Cancelacion administrativa</title>
</head>
...
<table width="100%%" cellpadding="0" cellspacing="0">
  ...
  <tr><td style="padding:28px 28px 16px;">
    ...
    <h2 style="margin:16px 0 0;font-size:18px;color:#1C1A18;">Cancelacion administrativa</h2>
    <p style="margin:10px 0 0;font-size:13px;color:#5a5047;line-height:1.7;">
      Tu reservacion <strong>%s</strong> fue cancelada por el equipo de Movent.
    </p>
  </td></tr>
    ...
    <table width="100%%" cellpadding="0" cellspacing="0"
      ...
      <tr><td style="padding:14px 16px;">
        ...
        <div style="font-size:12px;color:#5a5047;line-height:1.6;">
          Si tenias pagos asociados a esta reservacion, se procesaran los reembolsos
          correspondientes segun los terminos y condiciones aplicables.
  ...
  <tr><td style="padding:0 28px 24px;">
    <table width="100%%" cellpadding="0" cellspacing="0"><tr>
      <td style="font-size:10px;color:#9a9089;line-height:1.7;
        ...
        Cancelacion realizada por el equipo administrativo de Movent.
        Si crees que esto es un error, contactanos a la brevedad.
      </td>
    </tr></table>
  </td></tr>
