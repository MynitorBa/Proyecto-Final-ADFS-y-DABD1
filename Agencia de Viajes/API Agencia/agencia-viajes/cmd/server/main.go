...
func main() {
	...
	pagoController := controllers.NewPagoController(pagoService, logSesionService, emailService)
	...
	api := router.Group("/api")
	{
		...
		protegido.Use(middlewares.AuthRequerido())
		{
			...
			protegido.GET("/reservaciones/mias/pendiente", misReservacionesController.ObtenerPendiente)
			...
			protegido.POST("/reservaciones/:id/correo-actualizacion-habitacion", reservacionController.EnviarCorreoActualizacionHabitacion)
			protegido.POST("/reservaciones/:id/correo-actualizacion-asiento", reservacionController.EnviarCorreoActualizacionAsiento)
			...
			admin.Use(middlewares.RolRequerido(helpers.RolAdmin))
			{
				...
				admin.GET("/admin/reservaciones/gestion", adminController.ListarReservacionesGestion)
				admin.PUT("/admin/reservaciones/:id/editar-hotel-fechas", adminController.EditarFechasHotelAdmin)
